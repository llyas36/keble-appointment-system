            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <?php
                    if($_POST){
                        ...
                        //echo $sqlpt2;
                        //echo $sqlpt1;
                        $sqlmain= "select schedule.scheduleid,schedule.title,staff.stuname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join staff on schedule.stuid=staff.stuid ";
                        ...
                        $sqlmain= "select schedule.scheduleid,schedule.title,staff.stuname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join staff on schedule.stuid=staff.stuid  order by schedule.scheduledate desc";
