            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <td width="30%">
                        <select name="stuid" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "select appointment.appoid,schedule.scheduleid,schedule.title,staff.stuname,resident.resname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join resident on resident.resid=appointment.resid inner join staff on schedule.stuid=staff.stuid  order by schedule.scheduledate desc";
