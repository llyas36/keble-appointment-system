    ...
    if($_POST){
        ...
        if ($password==$cpassword){
            ...
            if($id2!=$id){
                ...
                //$sql1="insert into staff(stuemail,stuname,stupassword,stunic,stutel,specialties) values('$email','$name','$password','$nic','$tele',$spec);";
    ...
    header("location: staffs.php?action=edit&error=".$error."&id=".$id);
    ?>
