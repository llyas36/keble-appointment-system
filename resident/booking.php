                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Staff name or Email or Date (YYYY-MM-DD)" list="staffs" >&nbsp;&nbsp;
                        ...
                        <tbody>
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    $sqlmain= "select * from schedule inner join staff on schedule.stuid=staff.stuid where schedule.scheduleid=? order by schedule.scheduledate desc";
                                    $stmt = $database->prepare($sqlmain);
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            Staff name:  &nbsp;&nbsp;<b>'.$stuname.'</b><br>
                                                            Staff Email:  &nbsp;&nbsp;<b>'.$stuemail.'</b> 
                                                        </div>
