            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = $database->query("select  * from  schedule where stuid=$userid;");
                ...
                $sqlmain= "select schedule.scheduleid,schedule.title,staff.stuname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join staff on schedule.stuid=staff.stuid where staff.stuid=$userid ";
                    if($_POST){
                        //print_r($_POST);
                        $sqlpt1="";
