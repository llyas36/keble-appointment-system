                    ...
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex">
                                        <div class="btn-icon-back dashboard-icons-setting" style="background-image: url('../img/icons/staffs-hover.svg');"></div>
                                        <div>
                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        <div class="btn-icon-back dashboard-icons-setting" style="background-image: url('../img/icons/residents-hover.svg');"></div>
                                        <div>
